...
/* themes/custom/nmrf/templates/menu--main.html.twig */
class __TwigTemplate_3ffbb208b9c568134fed7cdb135f3829da1dfa3df88a71dbefb39e16579dd63c extends \Twig\Template
{
...
$context["item"], "url", []), "toString", [], "method"))))];
                    ...
                    if ($this->getAttribute($context["item"], "below", [])) {
                        // line 58
                        echo "          ";
                        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getLink($this->sandbox->ensureToStringAllowed($context["item"]), $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "url", [])), ["class" => "nav-link dropdown-toggle menu-link-toggle", "data-toggle" => "dropdown", "aria-expanded" => "false", "aria-haspopup" => "true"]), "html", null, true);
                        echo "
          ";
                        // line 59
                        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getLink($this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "title", [])), $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "url", [])), ["class" => "nav-link"]), "html", null, true);
                        echo "
          ";
                        // line 60
  ...
  ";
    ...
    {
        return "themes/custom/nmrf/templates/menu--main.html.twig";
    }
    ...
    {
        return array (  156 => 66,  149 => 64,  143 => 62,  138 => 60,  134 => 59,  129 => 58,  126 => 57,  124 => 54,  123 => 53,  122 => 52,  121 => 51,  120 => 50,  119 => 49,  114 => 47,  112 => 44,  111 => 43,  110 => 42,  109 => 41,  108 => 40,  107 => 39,  105 => 38,  100 => 37,  96 => 35,  90 => 33,  87 => 32,  84 => 31,  81 => 30,  67 => 29,  60 => 27,  57 => 22,  55 => 21,);
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      <li{{ item.attributes.addClass(classes) }}>
        ...
        %}
        {% if item.below %}
          {{ link(item, item.url, {'class': 'nav-link dropdown-toggle menu-link-toggle', 'data-toggle': 'dropdown', 'aria-expanded': 'false', 'aria-haspopup': 'true' }) }}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/nmrf/templates/menu--main.html.twig", "/var/www/html/nmrf/themes/custom/nmrf/templates/menu--main.html.twig");
    }
}
