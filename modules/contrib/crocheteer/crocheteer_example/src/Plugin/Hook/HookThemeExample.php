...
use Drupal\crocheteer\Hook\Theme\HookThemePlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookThemeExample.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookTheme(
 *   id = "crocheteer_example_theme_example",
 *   title = @Translation("Crocheteer Example Theme Example"),
 * )
 */
final class HookThemeExample extends HookThemePlugin implements ContainerFactoryPluginInterface {
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Theme dispatched by ' . $this->event->getDispatcherType() . '!');
  }
