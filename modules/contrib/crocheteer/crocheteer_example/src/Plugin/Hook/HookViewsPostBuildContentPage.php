...
use Drupal\crocheteer\Hook\Views\PostBuild\HookViewsPostBuildPlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookViewsPostBuildContentPage.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookViewsPostBuild(
 *   id = "crocheteer_example_views_post_build_content_page",
 *   title = @Translation("Crocheteer Example Views Post-Build Content Page"),
 *   viewsIds = {
 *     "content",
 *   },
 *   displays = {
 ...
 * )
 */
final class HookViewsPostBuildContentPage extends HookViewsPostBuildPlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookViewsPostBuildContentPage constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: View ' . $this->event->getView()->getTitle() . ' Post-Built!');
  }
