...
use Drupal\crocheteer\Hook\Entity\Delete\HookEntityDeletePlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookEntityDeleteNodePage.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookEntityDelete(
 *   id = "crocheteer_example_entity_delete_node_page",
 *   title = @Translation("Crocheteer Example Entity Delete Node Page"),
 *   entityTypeIds = {
 *     "node",
 *   },
 *   bundles = {
 ...
 * )
 */
final class HookEntityDeleteNodePage extends HookEntityDeletePlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookEntityDeleteNodePage constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Page Node ID ' . $this->event->getEntity()->id() . ' Deleted!');
  }
