...
use Drupal\crocheteer\Hook\Path\Insert\HookPathInsertPlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookPathInsertExample.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookPathInsert(
 *   id = "crocheteer_example_path_insert_example",
 *   title = @Translation("Crocheteer Example Path Insert Example"),
 * )
 */
final class HookPathInsertExample extends HookPathInsertPlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookPathInsertExample constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Path with alias ' . $this->event->getAlias() . ' Inserted!');
  }
