...
use Drupal\crocheteer\Hook\Entity\PreDelete\HookEntityPreDeletePlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookEntityPreDeleteNodePage.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookEntityPreDelete(
 *   id = "crocheteer_example_entity_pre_delete_node_page",
 *   title = @Translation("Crocheteer Example Entity Pre-Delete Node Page"),
 *   entityTypeIds = {
 *     "node",
 *   },
 *   bundles = {
 ...
 * )
 */
final class HookEntityPreDeleteNodePage extends HookEntityPreDeletePlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookEntityPreDeleteNodePage constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Page Node ID ' . $this->event->getEntity()->id() . ' Pre-Deleted!');
  }
