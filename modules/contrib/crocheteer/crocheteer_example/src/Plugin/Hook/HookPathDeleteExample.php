...
use Drupal\crocheteer\Hook\Path\Delete\HookPathDeletePlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookPathDeleteExample.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookPathDelete(
 *   id = "crocheteer_example_path_delete_example",
 *   title = @Translation("Crocheteer Example Path Delete Example"),
 * )
 */
final class HookPathDeleteExample extends HookPathDeletePlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookPathDeleteExample constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Path with PID ' . $this->event->getPid() . ' Deleted!');
  }
