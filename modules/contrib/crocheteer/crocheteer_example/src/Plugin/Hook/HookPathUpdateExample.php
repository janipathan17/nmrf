...
use Drupal\crocheteer\Hook\Path\Update\HookPathUpdatePlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookPathUpdateExample.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookPathUpdate(
 *   id = "crocheteer_example_path_update_example",
 *   title = @Translation("Crocheteer Example Path Update Example"),
 * )
 */
final class HookPathUpdateExample extends HookPathUpdatePlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookPathUpdateExample constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Path with source ' . $this->event->getSource() . ' Updated!');
  }
