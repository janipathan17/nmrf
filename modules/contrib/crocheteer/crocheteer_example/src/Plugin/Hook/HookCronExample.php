...
use Drupal\crocheteer\Hook\Cron\HookCronPlugin;
use Drupal\crocheteer\Hook\HookPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class HookCronExample.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookCron(
 *   id = "crocheteer_example_cron_example",
 *   title = @Translation("Crocheteer Example Cron Example"),
 * )
 */
final class HookCronExample extends HookCronPlugin implements ContainerFactoryPluginInterface {
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Cron dispatched by ' . $this->event->getDispatcherType() . '!');
  }
