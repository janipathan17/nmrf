...
/**
 * Class HookEntityPreSaveNodePage.
 *
 * Only implement the ContainerFactoryPluginInterface if you need dependency
 * injection mechanisms.
 *
 * @HookEntityPreSave(
 *   id = "crocheteer_example_entity_pre_save_node_page",
 *   title = @Translation("Crocheteer Example Entity Pre-Save Node Page"),
 *   entityTypeIds = {
 *     "node",
 *   },
 *   bundles = {
 ...
 * )
 */
final class HookEntityPreSaveNodePage extends HookEntityPreSavePlugin implements ContainerFactoryPluginInterface {
  ...
  /**
   * HookEntityPreSaveNodePage constructor.
   *
  ...
  public function hook() : void {
    $this->messenger->addStatus('Hooks Example: Page Node ' . $this->event->getEntity()->label() . ' Pre-Saved!');
  }
